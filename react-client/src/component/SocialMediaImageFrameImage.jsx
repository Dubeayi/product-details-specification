...
render() {
    return (
      <div className='SocialMediaImageFrame' style={{transform: this.props.transform}} onMouseEnter={this.showModal} onMouseLeave={this.hideModal}>
        <div className='SocialMediaImageOverlay' onClick={this.props.openClickModal} style={this.state.modalState}>
          ...
          <svg height="11" viewBox="0 0 12 11" width="12" stroke="rgb(255, 255, 255)"><path d="M0,3 C0,5.5 5,9 5,9 C5,9 10,5.4 10,3 C10,-1 5,-0.5 5,1.9 C5,-0.5 0,-1 0,3 Z" fill="none" strokeLinecap="round" strokeLinejoin="round" transform="translate(1 1)"></path></svg> # likes
          </div>
        </div>
